...
<div class="row">
	...
	<div class="col-sm-9">
		<h2>{{ $album->name }}</h2>
		<p>{{ $album->intro }}</p>
		<button class="btn btn-primary" type="button" data-target="#uploadPhoto" data-toggle="modal">
			Upload Photo
		</button>
		<button class="btn btn-info" type="button" data-target="#editAlbum" data-toggle="modal">Edit Album</button>
		<button class="btn btn-danger" type="button" data-target="#deleteAlbum" data-toggle="modal">Delete Album</button>
	</div>
</div>
{{-- upload photo modal --}}
